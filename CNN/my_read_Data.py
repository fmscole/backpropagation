...
class my_data_set:
    def __init__(self, kind='train'):
        if kind=='train':
            images_path =r'../mnist/train-images.idx3-ubyte'
            labels_path =r'../mnist/train-labels.idx1-ubyte' 
        else: 
            images_path =r'../mnist/t10k-images.idx3-ubyte' 
            labels_path =r'../mnist/t10k-labels.idx1-ubyte' 
